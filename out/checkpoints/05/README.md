...
Generated 2026-07-15T21:11:00Z.

A full seeded mission, start to extraction (docs/09/11 — "this is the definition of done"): seed -> hulk -> insert both modes (a landing squad, a deep-struck enemy squad) -> a deterministic AI queuing multi-action turns through the real two-phase resolve loop -> gather -> extract. combat.log is included alongside this README. Look for: does it terminate well within the turn cap? Does the log read as a coherent battle? Is every mechanic (shot plane, dartboard, DT/ricochet, cook-off, RAM, surrogate decay, tactics/resolution abort-and-continue, extraction) visibly exercised somewhere in it?
